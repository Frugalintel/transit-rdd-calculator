        ...
        <div className="space-y-6">
            ...
            `}>
                <Button 
                    ...
                    className={`px-6 ${isFallout && activeTab === 'holidays' ? 'fo-button fo-button-primary' : (isFallout ? 'fo-button fo-button-ghost' : '')}`}
                >
                ...
                <Button 
                    ...
                    className={`px-6 ${isFallout && activeTab === 'seasons' ? 'fo-button fo-button-primary' : (isFallout ? 'fo-button fo-button-ghost' : '')}`}
                >
                ...
                <Button 
                    ...
                    className={`px-6 ${isFallout && activeTab === 'weights' ? 'fo-button fo-button-primary' : (isFallout ? 'fo-button fo-button-ghost' : '')}`}
                >
            ...
            <div className="min-h-[400px]">
                {activeTab === 'holidays' && (
                    <div className="space-y-4">
                        <div className="flex justify-between items-center">
                            <h3 className={`text-xl ${isFallout ? 'fo-heading border-none' : 'mc-admin-heading'}`}>Federal Holidays</h3>
                ...
                {activeTab === 'seasons' && (
                    <div className="space-y-4">
                        <div className="flex justify-between items-center">
                            <h3 className={`text-xl ${isFallout ? 'fo-heading border-none' : 'mc-admin-heading'}`}>Peak Seasons</h3>
                            <Button variant="primary" className={isFallout ? "fo-button" : ""}>
                                <ThemeIcon type="firework" className="mr-2" />
                                Add Season
                            </Button>
                ...
                {activeTab === 'weights' && (
                    <div className="space-y-4">
                        <div className="flex justify-between items-center">
                            <h3 className={`text-xl ${isFallout ? 'fo-heading border-none' : 'mc-admin-heading'}`}>Transit Weight Ranges</h3>
                            <Button variant="primary" className={isFallout ? "fo-button" : ""}>
                                <ThemeIcon type="firework" className="mr-2" />
                                Add Range
                            </Button>
